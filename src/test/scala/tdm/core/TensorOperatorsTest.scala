...
class TensorOperatorsTest extends FlatSpec with Matchers {    
    ...
    it should "perform union on 2 String tensors" in {
        ...
        tensor.addValue(Dimension1.value("d11"), Dimension2.value("d21"), Dimension3.value(1))("e11")
        tensor.addValue(Dimension1.value("d12"), Dimension2.value("d22"), Dimension3.value(2))("e12")
        
    	val tensor2 = TensorBuilder[String]
    	    .addDimension(Dimension1)
    	    .addDimension(Dimension2)
    	    .addDimension(Dimension3)
    	    .build()
    	    
    	tensor2.addValue(Dimension1.value("d12"), Dimension2.value("d22"), Dimension3.value(2))("e21")    
    	tensor2.addValue(Dimension1.value("d13"), Dimension2.value("d23"), Dimension3.value(3))("e22")
        tensor2.addValue(Dimension1.value("d14"), Dimension2.value("d24"), Dimension3.value(4))("e23")
	    
        val tensorUnion = tensor.union(tensor2)((v1, v2) => v1 + v2)
        
        tensorUnion(Dimension1.value("d11"), Dimension2.value("d21"), Dimension3.value(1)) shouldBe Some("e11")
    	tensorUnion(Dimension1.value("d12"), Dimension2.value("d22"), Dimension3.value(2)) shouldBe Some("e12e21")
    	tensorUnion(Dimension1.value("d13"), Dimension2.value("d23"), Dimension3.value(3)) shouldBe Some("e22")
    	tensorUnion(Dimension1.value("d14"), Dimension2.value("d24"), Dimension3.value(4)) shouldBe Some("e23")
    }
    ...
    it should "perform difference on 2 String tensors" in {
    	val tensor = TensorBuilder[String]
            .addDimension(Dimension1)
            .addDimension(Dimension2)
            .addDimension(Dimension3)
        ...
        tensorDifference(Dimension1.value("d11"), Dimension2.value("d21"), Dimension3.value(1)) shouldBe Some("e11")
    	tensorDifference(Dimension1.value("d12"), Dimension2.value("d22"), Dimension3.value(2)) shouldBe None
    	tensorDifference(Dimension1.value("d13"), Dimension2.value("d23"), Dimension3.value(3)) shouldBe None
    	tensorDifference(Dimension1.value("d14"), Dimension2.value("d24"), Dimension3.value(4)) shouldBe None
    }
